...
import AdminLivePolls from './Pages/Admin/AdminLivePolls';
  ...
  return (
    ...
    >
      <Routes>
        ...
        <Route
          path="/admin/live-polls"
          element={
            <ProtectedRoute
              allowedRoles={['super-admin', 'event-lead']}
              fallbackPath="/admin"
              toastMessage="Access Denied: Only Event Leads and Super Admins can manage Live Polls."
            >
              <AdminLivePolls />
            </ProtectedRoute>
          }
