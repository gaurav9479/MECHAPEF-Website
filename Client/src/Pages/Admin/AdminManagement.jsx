...
const BASE_SECTION_KEYS = [
  ...
  { key: 'dept_1_mob', label: 'Dept Image 1 (Mobile)', aspectRatio: 1 },
  { key: 'dept_2', label: 'Dept Image 2 (Desktop)', aspectRatio: 1/1.25 },
  { key: 'dept_2_mob', label: 'Dept Image 2 (Mobile)', aspectRatio: 1 },
  { key: 'dept_3', label: 'Dept Image 3 (Desktop)', aspectRatio: 1/1.25 },
  { key: 'dept_3_mob', label: 'Dept Image 3 (Mobile)', aspectRatio: 1 },
  { key: 'dept_4', label: 'Dept Image 4 (Desktop)', aspectRatio: 1/1.25 },
  { key: 'dept_4_mob', label: 'Dept Image 4 (Mobile)', aspectRatio: 1 },
  { key: 'dept_5', label: 'Dept Image 5 (Desktop)', aspectRatio: 1/1.25 },
  { key: 'dept_5_mob', label: 'Dept Image 5 (Mobile)', aspectRatio: 1 },
  { key: 'dept_6', label: 'Dept Image 6 (Desktop)', aspectRatio: 1/1.25 },
  { key: 'dept_6_mob', label: 'Dept Image 6 (Mobile)', aspectRatio: 1 },
  { key: 'dept_7', label: 'Dept Image 7 (Desktop)', aspectRatio: 1/1.25 },
  { key: 'dept_7_mob', label: 'Dept Image 7 (Mobile)', aspectRatio: 1 },
  { key: 'dept_8', label: 'Dept Image 8 (Desktop)', aspectRatio: 1/1.25 },
  { key: 'dept_8_mob', label: 'Dept Image 8 (Mobile)', aspectRatio: 1 },
